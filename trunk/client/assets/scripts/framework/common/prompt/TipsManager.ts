...
class TipsManager {
    ...
    confirmTips(title: string, content: string, okWord: string, needOk: boolean, cb?: Function) {
        let operate: any = {
            title: title,
            content: content,
            okWord: okWord,
        ...
        oops.gui.open(UIID.ConfirmTips, operate, tips.getPopCommonEffect());
    }

    confirm(title: string, content: string, cb: Function, okWord: string = "ok", cancelWord: string = "cancel") {
        let operate: any = {
            title: title,
            content: content,
            okWord: okWord,
