...
async function convert(src, dst, name, isClient) {
                ...
                if (isWrite) {
                    ...
                    switch (type) {
                        case "int":
                            ...
                            break;
                        case "long":
                            // console.warn(`${index}long`, key, value, cell.string, cell.number, cell.result)
                            if (cell.formula) {
                                data[key] = parseInt(cell.result);
                            }
                            else {
    ...
    if (r["undefined"] == null) {
        ...
        if (isClient) {
            ...
            (0, JsonToTs_1.createTsServer)(name, types_server, r, primary);
        }
