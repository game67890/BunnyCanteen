    ...
    execute: function () {
      ...
      _export("PaymentComponent", PaymentComponent = (_dec = ccclass('PaymentComponent'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(_crd && VirtualGridList === void 0 ? (_reportPossibleCrUseOfVirtualGridList({
        ...
        showShopList() {
          ...
          for (const key in (_crd && PaymentMgr === void 0 ? (_reportPossibleCrUseOfPaymentMgr({
            error: Error()
          }), PaymentMgr) : PaymentMgr).shopItemList) {
            if ((_crd && PaymentMgr === void 0 ? (_reportPossibleCrUseOfPaymentMgr({
              error: Error()
            }), PaymentMgr) : PaymentMgr).shopItemList.hasOwnProperty(key)) {
              let value = (_crd && PaymentMgr === void 0 ? (_reportPossibleCrUseOfPaymentMgr({
                error: Error()
              }), PaymentMgr) : PaymentMgr).shopItemList[key];
          ...
          var completeBuy = ret => {
            ...
            if (ret.isSucc && ret.res.result) {
              ...
              if (ret.res.Type == "Need_To_Pay") {
                ...
                let paramas = {};
                paramas.item = (_crd && PaymentMgr === void 0 ? (_reportPossibleCrUseOfPaymentMgr({
                  error: Error()
