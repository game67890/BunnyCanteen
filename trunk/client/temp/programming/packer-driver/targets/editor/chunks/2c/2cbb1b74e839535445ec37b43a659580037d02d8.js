    ...
    execute: function () {
      ...
      _export("Vec3Util", Vec3Util = class Vec3Util {
        ...
        static normalize(pos) {
          const outPos = new Vec3(pos.x, pos.y, pos.z);
        ...
        static rotateTo(from, to, angle) {
          ...
          const axis = new Vec3(); // 获得旋转轴

          Vec3.cross(axis, from, to);
          axis.normalize();
          const radian = angle * Math.PI / 180; // 获得弧度
        ...
        static bezierTwo(t, posStart, posCon, posEnd) {
          ...
          const n = 1 - t;
          const tt = t * t;
          const pStart = posStart.clone();
          const pos = new Vec3();
          const pCon = posCon.clone();
          const pEnd = posEnd.clone();
        ...
        static bezierThree(t, posStart, posCon1, posCon2, posEnd) {
          ...
          const pCon1 = posCon1.clone();
          const pCon2 = posCon2.clone();
          const pEnd = posEnd.clone();
        ...
        static cross(dir1, dir2) {
          ...
          const tempDir1 = new Vec3(dir1.x, dir1.y, dir1.z);
          const tempDir2 = new Vec3(dir2.x, dir2.y, dir2.z);
          const iv = i.multiplyScalar(tempDir1.y * tempDir2.z - tempDir2.y * tempDir1.z);
          const jv = j.multiplyScalar(tempDir2.x * tempDir1.z - tempDir1.x * tempDir2.z);
          const kv = k.multiplyScalar(tempDir1.x * tempDir2.y - tempDir2.x * tempDir1.y);
        ...
        static dirAngle(a, b) {
          const c = Vec3Util.cross(a, b);
          const angle = Vec3Util.angle(a, b); // a 到 b 的夹角
...
//# sourceMappingURL=2cbb1b74e839535445ec37b43a659580037d02d8.js.map