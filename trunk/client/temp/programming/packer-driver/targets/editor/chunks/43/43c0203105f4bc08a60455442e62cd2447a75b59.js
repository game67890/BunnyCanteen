      ...
      _export("HeChengManager", HeChengManager = class HeChengManager {
        ...
        onCaiGou(isAuto) {
          ...
          if ((_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
            ...
            let IngredientsId = this.GetSucaiIdByCanTingLv((_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
              error: Error()
            }), TonGameMgr) : TonGameMgr).CanTingLevel);
        ...
        GetMaxCantingLevel() {
          ...
          let jsonTabel = (_crd && JsonUtil === void 0 ? (_reportPossibleCrUseOfJsonUtil({
            error: Error()
        ...
        OnAutoHuiShou() {
          ...
          if (this._tsRestaurantlevel.recoverylevel > 0) {
            for (let index = 0; index < (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              error: Error()
            }), BoardMgr) : BoardMgr).board.length; index++) {
              const cell = (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
                error: Error()
        ...
        OnAutoHecheng() {
          for (let i = 0; i < (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
            error: Error()
          }), BoardMgr) : BoardMgr).board.length; i++) {
            for (let j = i + 1; j < (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              error: Error()
              ...
              if ((_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
                ...
                let NextSuCaiId = this.GetNextLevelSuCaiId((_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
                  error: Error()
        ...
        HandleHecheng(srcIndex, destIndex) {
          if ((_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
            ...
            let srcSuCaiId = (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              error: Error()
            }), BoardMgr) : BoardMgr).board[srcIndex].SuCaiId;
            let destSuCaiId = (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              error: Error()
              ...
              if (NextSuCaiId > 0) {
                ...
                if (HechengGUI) {
                  ...
                  if (HechengCom) {
                    ...
                    if (gridNode) {
                      const gridComponent = gridNode.getComponent(_crd && GridComponent === void 0 ? (_reportPossibleCrUseOfGridComponent({
                        error: Error()
                      ...
                      if (gridComponent) {
                        ...
                        if (srcGridNode) {
                          const srcGridComponent = srcGridNode.getComponent(_crd && GridComponent === void 0 ? (_reportPossibleCrUseOfGridComponent({
                            error: Error()
                          }), GridComponent) : GridComponent);
        ...
        AddCanTingExp(NextSuCaiId) {
          ...
          if (this._tsRestaurantlevel.exp > 0) {
            if ((_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
              ...
              //餐厅可以升级了
              let nextLevel = (_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
                error: Error()
              ...
              if (nextLevel <= this.GetMaxCantingLevel()) {
                ...
                let tips = (_crd && StringUtil === void 0 ? (_reportPossibleCrUseOfStringUtil({
                  error: Error()
