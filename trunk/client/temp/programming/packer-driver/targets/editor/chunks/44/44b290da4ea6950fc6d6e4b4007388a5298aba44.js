      ...
      _export("LiWuManager", LiWuManager = class LiWuManager {
        ...
        GenLiWu() {
          ...
          if (HechengGUI) {
            ...
            if (HechengCom && (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              ...
              let LiwuIndex = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                error: Error()
              }), UtilMgr) : UtilMgr).getRandomNumber(LiwuIdList);
              let gridNode = HechengCom.getGridNode(LiwuIndex);

              if (gridNode) {
                let liwu = HechengCom.createLiwu(); // 获取屏幕的大小
        ...
        openLiwu(index) {
          if ((_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
            ...
            let IngredientsId = this.RankdomDishByCanTingLv((_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
              error: Error()
            }), TonGameMgr) : TonGameMgr).CanTingLevel);
        ...
        RankdomDishByCanTingLv(level) {
          ...
          if (jsonIngredients) {
            ...
            let IngredientsId = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
              error: Error()
        ...
        getTodayDate() {
          const today = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
        ...
        getDailyLiWu(numlimit) {
          const savedData = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
