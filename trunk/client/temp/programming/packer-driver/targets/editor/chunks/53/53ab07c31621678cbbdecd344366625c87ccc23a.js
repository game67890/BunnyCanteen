    ...
    execute: function () {
      ...
      _export("LayerManager", LayerManager = class LayerManager {
        ...
        toast(content, useI18n = false) {
          let tablerecord = new (_crd && TableSoundEffects === void 0 ? (_reportPossibleCrUseOfTableSoundEffects({
            error: Error()
          ...
          let newContent = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
