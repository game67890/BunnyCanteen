  ...
  return {
    ...
    execute: function () {
      ...
      _export("AssetManagerEx", AssetManagerEx = class AssetManagerEx {
          ...
          if (!Object.getOwnPropertyDescriptor(Asset.prototype, 'addRef')) {
            Object.defineProperties(Asset.prototype, {
              ...
              decRef: {
                configurable: true,
                writable: true,
                value: function (autoRelease = true) {
                  --this.refCount;
        ...
        cacheAsset(assetOrUrlOrUuid, add = false) {
        ...
        releaseAsset(assetOrUrlOrUuid, dec = false) {
          let key = this.getReferenceKey(assetOrUrlOrUuid);
