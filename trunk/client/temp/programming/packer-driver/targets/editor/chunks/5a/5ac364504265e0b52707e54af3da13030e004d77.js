      ...
      _export("TonComponent", TonComponent = (_dec = ccclass('TonComponent'), _dec2 = property({
        ...
        */
        ...
        async _initTonConnect() {
          ...
          let uiconnector = new (_crd && TonConnectUI === void 0 ? (_reportPossibleCrUseOfTonConnectUI({
            error: Error()
          ...
          this._cocosGameFi = await (_crd && GameFi === void 0 ? (_reportPossibleCrUseOfGameFi({
            error: Error()
        ...
        _initEvmConnect() {
          ...
          const projectId = 'a3c5251fe077f63e2fe1931521283512'; // 2. Set chains
          ...
          const ethersConfig = (_crd && defaultConfig === void 0 ? (_reportPossibleCrUseOfdefaultConfig({
            error: Error()
        ...
        async evmConnectEventHandle(event) {
