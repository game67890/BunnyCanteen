      ...
      _export("RoleManager", RoleManager = class RoleManager {
        ...
        UpdateVisitors() {
          ...
          if (HechengGUI) {
            ...
            if (HechengCom && (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
              ...
              let SpawnNum = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                error: Error()
              }), UtilMgr) : UtilMgr).getRandomNumber(this.SpawnRoleNum);
              let DiningTableIndex = (_crd && DiningTableMgr === void 0 ? (_reportPossibleCrUseOfDiningTableMgr({
                error: Error()
              ...
              if (DiningTableIndex >= 0) {
                ...
                let SoundEffect = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                  error: Error()
                ...
                for (let i = 0; i < SpawnNum; i++) {
                  ...
                  this.RoleList.push(noUseRole); //const halfRoleHeight = noUseRole.RoleNode.getComponent(UITransform).height / 2;
                  //noUseRole.RoleNode.setPosition((Math.random() - 0.5) * 100, -halfRoleHeight);

                  const roleComponent = noUseRole.RoleNode.getComponent(_crd && RoleComponent === void 0 ? (_reportPossibleCrUseOfRoleComponent({
                    error: Error()
        ...
        MoveToPos(roleInfo, DiningTableIndex, SpawnNum, index) {
          if (roleInfo && roleInfo.RoleNode) {
            let TargetPos = this.getPositionInParent(roleInfo.RoleNode, (_crd && DiningTableMgr === void 0 ? (_reportPossibleCrUseOfDiningTableMgr({
              error: Error()
            }), DiningTableMgr) : DiningTableMgr).TableList[DiningTableIndex].tableNode, index);
            let speed = 100;
            let pos = roleInfo.RoleNode.position;
            const roleComponent = roleInfo.RoleNode.getComponent(_crd && RoleComponent === void 0 ? (_reportPossibleCrUseOfRoleComponent({
              error: Error()
            }), RoleComponent) : RoleComponent);
