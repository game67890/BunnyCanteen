System.register(["@tonconnect/sdk", "ua-parser-js", "deepmerge", "classnames"], function (_export, _context) {
  ...
  return {
    setters: [function (_tonconnectSdk) {
      ...
      for (var _key in _tonconnectSdk) {
        if (_key !== "default" && _key !== "__esModule") _exportObj[_key] = _tonconnectSdk[_key];
      }
...
`;
      ...
      template = (str, params, reg = /{{(.*?)}}/g) => str.replace(reg, (_, key) => deepReadObject(params, key, ""));

      createI18nContext = (init = {}, lang = navigator.language in init ? navigator.language : Object.keys(init)[0]) => {
    ...
    `;
        return createMemo((() => {
          ...
          return () => _c$() ? (() => {
            ...
            createRenderEffect(_p$ => {
              const _v$ = cn(svgClass, props.class),
                    _v$2 = fill();
            ...
            return () => _c$2() ? (() => {
              ...
              createRenderEffect(_p$ => {
                const _v$3 = cn(svgClass, props.class),
                      _v$4 = fill();
              ...
              createRenderEffect(_p$ => {
                const _v$5 = cn(svgClass, props.class),
                      _v$6 = fill();
...
`;
      ...
      DesktopSelectWalletModalStyled = styled.div`
    display: flex;
    flex-direction: column;
    align-items: center;
`;
...
`;
    ...
    font-size: 15px;
`;
      StyledIconButton$3 = styled(IconButton)`
    position: absolute;
    top: 16px;
    left: 16px;
`;
...
`;
    ...
    margin: 0 auto;
`;
      TelegramButtonStyled = styled(Button)`
    margin: 0 24px 24px;
    width: calc(100% - 48px);
    border-radius: ${props => borders$1[props.theme.borderRadius]};
