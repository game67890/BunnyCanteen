  ...
  return {
    ...
    execute: function () {
      ...
      _export("HttpRequest", HttpRequest = class HttpRequest {
        ...
        postByArraybuffer(name, onComplete, params = null) {
          this.sendRequest(name, params, true, onComplete, 'arraybuffer');
        }
        /**
         * HTTP POST请求
         * @param name                  协议名
            ...
            if (xhr.status == 200 && onComplete) {
              ...
              if (responseType == 'arraybuffer') {
                ...
                try {
                  ...
                  console.log("JSON parse xhr.response failed");
                }
              }
...
//# sourceMappingURL=b804a9901c5ae07bb22233c541ced9c2fed947b0.js.map