      ...
      _export("TonGameManager", TonGameManager = class TonGameManager {
        ...
        init() {
          ...
          var completeLogin = ret => {
            if (ret.isSucc) {
              let Func = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                error: Error()
          ...
          const param = JSON.stringify(data); //oops.gui.toast("userid: " + data.userID + "\ninviterID:" + data.inviter, true);
        ...
        OnOneSecondUpdate() {
          let tempgain = (_crd && AcceleratedBuffMgr === void 0 ? (_reportPossibleCrUseOfAcceleratedBuffMgr({
            error: Error()
          ...
          const buffGUI = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
          }), oops) : oops).gui.get((_crd && UIID === void 0 ? (_reportPossibleCrUseOfUIID({
            error: Error()
          ...
          if (buffGUI) {
            const buffCom = buffGUI.getComponent(_crd && AcceleratedBuffMain === void 0 ? (_reportPossibleCrUseOfAcceleratedBuffMain({
              error: Error()
        ...
        getOrCreateUniqueID() {
          let uniqueID = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
        ...
        save() {
          ...
          const currentTimestampInSeconds = Math.floor((_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
        ...
        setData() {
          ...
          if ((_crd && AcceleratedBuffMgr === void 0 ? (_reportPossibleCrUseOfAcceleratedBuffMgr({
            ...
            let newdate = new Date((_crd && AcceleratedBuffMgr === void 0 ? (_reportPossibleCrUseOfAcceleratedBuffMgr({
              error: Error()
            }), AcceleratedBuffMgr) : AcceleratedBuffMgr).GetFreeBuffTimeStamp);
            let istoday = (_crd && GameUtils === void 0 ? (_reportPossibleCrUseOfGameUtils({
              error: Error()
          ...
          let lixianShouyi = (_crd && AcceleratedBuffMgr === void 0 ? (_reportPossibleCrUseOfAcceleratedBuffMgr({
            error: Error()
        ...
        checkMidnight() {
          const now = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
          }), oops) : oops).timer.getServerDate();
          const hours = now.getHours();
          const minutes = now.getMinutes(); // 如果当前时间是 00:00
