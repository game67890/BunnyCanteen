    ...
    execute: function () {
      ...
      _export("FeedManager", FeedManager = class FeedManager {
        ...
        UpdateHechengMaxLevel(sucaiid) {
          let tablerecord = new (_crd && TableIngredients === void 0 ? (_reportPossibleCrUseOfTableIngredients({
            error: Error()
          }), TableIngredients) : TableIngredients)();
        ...
        GetFreeDishId() {
          ...
          let tablerest = new (_crd && TableRestaurantlevel === void 0 ? (_reportPossibleCrUseOfTableRestaurantlevel({
            error: Error()
        ...
        SendBuyDish(confId, count) {
          var completeCBuyDish = ret => {
            ...
            if (ret.isSucc) {
              ...
              const FeedGUI = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
                error: Error()
              }), oops) : oops).gui.get((_crd && UIID === void 0 ? (_reportPossibleCrUseOfUIID({
                error: Error()
              }), UIID) : UIID).FeedMain);
              ...
              if (FeedGUI) {
                const FeedCom = FeedGUI.getComponent(_crd && FeedMain === void 0 ? (_reportPossibleCrUseOfFeedMain({
                  error: Error()
                }), FeedMain) : FeedMain);
