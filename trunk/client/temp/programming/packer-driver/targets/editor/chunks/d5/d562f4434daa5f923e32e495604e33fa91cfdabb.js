System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, SpriteFrame, Sprite, oops, UIID, TaskComponent, UtilMgr, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, TaskTabController;
  ...
  function _reportPossibleCrUseOfTaskComponent(extras) {
    _reporterNs.report("TaskComponent", "./TaskComponent", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TaskComponent = _unresolved_4.TaskComponent;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f50c1JEM7pLHoNFgZiCJBYj", "TaskTabController", undefined);
      ...
      _export("TaskTabController", TaskTabController = (_dec = ccclass('TaskTabController'), _dec2 = property([Node]), _dec3 = property([Node]), _dec4 = property(SpriteFrame), _dec5 = property(SpriteFrame), _dec(_class = (_class2 = class TaskTabController extends Component {
        constructor(...args) {
          super(...args);
        ...
        selectTab(index) {
          ...
          if (index == 1) {
            const TaskGUI = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
              error: Error()
            ...
            if (TaskGUI) {
              const TaskCom = TaskGUI.getComponent(_crd && TaskComponent === void 0 ? (_reportPossibleCrUseOfTaskComponent({
                error: Error()
...
//# sourceMappingURL=d562f4434daa5f923e32e495604e33fa91cfdabb.js.map