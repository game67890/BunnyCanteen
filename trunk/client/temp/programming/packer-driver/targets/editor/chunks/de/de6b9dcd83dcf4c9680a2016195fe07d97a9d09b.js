    ...
    execute: function () {
      ...
      _export("GPDrag", GPDrag = (_dec = ccclass('GPDrag'), _dec2 = property({
        ...
        start() {
          ...
          let moveNode = new (_crd && GPWorkFlowNode === void 0 ? (_reportPossibleCrUseOfGPWorkFlowNode({
            error: Error()
          ...
          moveNode.OnStart = wfNode => {
            ...
            switch (this.backHomeType) {
              ...
              case DragBackHomeType.Tween:
                ...
                let easing = EasingString[self.backTweenEasing];
          ...
          let arrivedNode = new (_crd && GPWorkFlowNode === void 0 ? (_reportPossibleCrUseOfGPWorkFlowNode({
            error: Error()
          }), GPWorkFlowNode) : GPWorkFlowNode)();
        ...
        OnDragStart(e) {
          ...
          const DragGridComponent = this.node.parent.getComponent(_crd && GridComponent === void 0 ? (_reportPossibleCrUseOfGridComponent({
            error: Error()
        ...
        OnDragEnd(e) {
          ...
          if ((_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
            ...
            if (DragGridComponent) {
              let destIndex = (_crd && BoardMgr === void 0 ? (_reportPossibleCrUseOfBoardMgr({
                error: Error()
              }), BoardMgr) : BoardMgr).getTouchItem(DragGridComponent.index);
