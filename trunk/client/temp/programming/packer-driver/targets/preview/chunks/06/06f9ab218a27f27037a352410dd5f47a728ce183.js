        ...
        onDataChanged() {
          ...
          var completeUserName = ret => {
            if (ret.isSucc && ret.res.ok) {
              var UserName = ret.res.result.first_name + ret.res.result.last_name;
              this.Name.string = UserName;
            }
          };

          var url = "https://api.telegram.org/bot" + (_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
            error: Error()
