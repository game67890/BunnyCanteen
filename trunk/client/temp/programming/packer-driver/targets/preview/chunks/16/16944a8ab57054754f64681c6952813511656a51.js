            ...
            try {
              if (sys.platform === sys.Platform.MOBILE_BROWSER) {
                (_crd && TelegramWebApp === void 0 ? (_reportPossibleCrUseOfTelegramWebApp({
                  ...
                  var TelegramInitData = (_crd && TelegramWebApp === void 0 ? (_reportPossibleCrUseOfTelegramWebApp({
                    error: Error()
                  }), TelegramWebApp) : TelegramWebApp).Instance.getTelegramInitData();
                  console.log("TelegramInitData : ", TelegramInitData);
                  var TelegramInitDataUnsafe = (_crd && TelegramWebApp === void 0 ? (_reportPossibleCrUseOfTelegramWebApp({
                    error: Error()
