    ...
    execute: function () {
      ...
      _export("default", Router = class Router {
        ...
        registerMethod(eventName, callback) {
          ...
          window["binding_router_" + eventName] = /*#__PURE__*/_asyncToGenerator(function* (args) {
            log(TAG, 'called eventName' + eventName);
            return _this.callMethod(eventName, args);
          });
        }
        ...
        callMethod(methodName, args) {
          ...
          if (method) {
            var data = args['data'];
            var exeResult = method.call(this, data); // 如果是在native环境下，则需要把结果返回到native中。
