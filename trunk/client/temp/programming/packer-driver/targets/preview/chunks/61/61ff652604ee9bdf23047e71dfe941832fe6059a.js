        ...
        onBeinContact(DestCollider, SrcCollider) {
          if (DestCollider.tag != SrcCollider.tag) {
            if (DestCollider.tag == 3 || SrcCollider.tag == 3) {
              ...
              var DestGridComponent = DestCollider.node.parent.getComponent(_crd && GridComponent === void 0 ? (_reportPossibleCrUseOfGridComponent({
                error: Error()
              }), GridComponent) : GridComponent);

              if (DestGridComponent) {
                var SrcGridComponent = SrcCollider.node.parent.getComponent(_crd && GridComponent === void 0 ? (_reportPossibleCrUseOfGridComponent({
                  error: Error()
                }), GridComponent) : GridComponent);
