  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", Binding = class Binding {
        ...
        callNativeMethod(methodName, args) {
          ...
          return new Promise((resolve, reject) => {
            ...
            if ((_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
              ...
              var resultCode = native.reflection.callStaticMethod('utils/binding/Binding', 'execute', '(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I', methodName, typeof args === 'object' ? JSON.stringify(args) : '', cbName);
              ...
              var retId = native.reflection.callStaticMethod('Binding', 'executeWithMethodName:args:callback:', methodName, typeof args === 'object' ? JSON.stringify(args) : '', cbName);
            } else {
        ...
        clearCallback(cbName, timeoutId, cbProgressName) {
          if (timeoutId === void 0) {
            timeoutId = -1;
          }

          if (cbProgressName === void 0) {
            cbProgressName = '';
          }
