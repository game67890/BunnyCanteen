System.register(["@tonconnect/protocol", "@tonconnect/isomorphic-eventsource", "@tonconnect/isomorphic-fetch"], function (_export, _context) {
  "use strict";

  var CONNECT_EVENT_ERROR_CODES, SEND_TRANSACTION_ERROR_CODES, Base64, SessionCrypto, hexToByteArray, TonConnectError, DappMetadataError, ManifestContentErrorError, ManifestNotFoundError, WalletAlreadyConnectedError, WalletNotConnectedError, UserRejectsError, BadRequestError, UnknownAppError, WalletNotInjectedError, LocalstorageNotFoundError, FetchWalletsError, WrongAddressError, ParseHexError, UnknownError, ConnectErrorsParser, RpcParser, SendTransactionParser, HttpBridgeGatewayStorage, BridgeGateway, BridgeConnectionStorage, BridgeProvider, InMemoryStorage, InjectedProvider, DefaultStorage, WalletsListManager, WalletNotSupportFeatureError, BrowserEventDispatcher, TonConnectTracker, TonConnect, connectEventErrorsCodes, connectErrorsParser, sendTransactionErrors, sendTransactionParser, PROTOCOL_VERSION, FALLBACK_WALLETS_LIST, tonConnectSdkVersion, noBounceableTag, testOnlyTag, toByteMap, ord, s;
  ...
  ***************************************************************************** */
  ...
  function callForSuccess(fn, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      var attempts = (_a = options === null || options === void 0 ? void 0 : options.attempts) !== null && _a !== void 0 ? _a : 10;
      var delayMs = (_b = options === null || options === void 0 ? void 0 : options.delayMs) !== null && _b !== void 0 ? _b : 200;
  ...
  function createResource(createFn, disposeFn) {
    ...
    var create = function create(signal) {
      ...
      return __awaiter(_this, void 0, void 0, function* () {
        ...
        var promise = createFn(abortController.signal, ...args);
        currentPromise = promise;
        var resource = yield promise;
    ...
    var dispose = () => __awaiter(this, void 0, void 0, function* () {
      try {
    ...
    var recreate = delayMs => __awaiter(this, void 0, void 0, function* () {
      var resource = currentResource;
      var promise = currentPromise;
  ...
  function createEventSource(config) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield timeout((resolve, reject, deferOptions) => __awaiter(this, void 0, void 0, function* () {
        ...
        var abortController = createAbortController(deferOptions.signal);
        ...
        var url = new URL(addPathToUrl(config.bridgeUrl, config.ssePath));
        url.searchParams.append('client_id', config.sessionId);
        var lastEventId = yield config.bridgeGatewayStorage.getLastEventId();
        ...
        eventSource.onerror = reason => __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            var newInstance = yield config.errorHandler(eventSource, reason);
  ...
  return {
    setters: [function (_tonconnectProtocol) {
      CONNECT_EVENT_ERROR_CODES = _tonconnectProtocol.CONNECT_EVENT_ERROR_CODES;
      SEND_TRANSACTION_ERROR_CODES = _tonconnectProtocol.SEND_TRANSACTION_ERROR_CODES;
      Base64 = _tonconnectProtocol.Base64;
      SessionCrypto = _tonconnectProtocol.SessionCrypto;
      hexToByteArray = _tonconnectProtocol.hexToByteArray;

      _export({
        CHAIN: _tonconnectProtocol.CHAIN,
        CONNECT_EVENT_ERROR_CODES: _tonconnectProtocol.CONNECT_EVENT_ERROR_CODES,
        CONNECT_ITEM_ERROR_CODES: _tonconnectProtocol.CONNECT_ITEM_ERROR_CODES,
        SEND_TRANSACTION_ERROR_CODES: _tonconnectProtocol.SEND_TRANSACTION_ERROR_CODES
      });
    }, function (_tonconnectIsomorphicEventsource) {}, function (_tonconnectIsomorphicFetch) {}],
    execute: function () {
      _export("TonConnectError", TonConnectError = class TonConnectError extends Error {
      ...
      _export("WalletAlreadyConnectedError", WalletAlreadyConnectedError = class WalletAlreadyConnectedError extends TonConnectError {
        get info() {
      ...
      _export("WalletNotConnectedError", WalletNotConnectedError = class WalletNotConnectedError extends TonConnectError {
        get info() {
      ...
      _export("UserRejectsError", UserRejectsError = class UserRejectsError extends TonConnectError {
        get info() {
      ...
      _export("BadRequestError", BadRequestError = class BadRequestError extends TonConnectError {
        get info() {
      ...
      _export("UnknownAppError", UnknownAppError = class UnknownAppError extends TonConnectError {
        get info() {
      ...
      _export("WalletNotInjectedError", WalletNotInjectedError = class WalletNotInjectedError extends TonConnectError {
        get info() {
      ...
      _export("LocalstorageNotFoundError", LocalstorageNotFoundError = class LocalstorageNotFoundError extends TonConnectError {
        get info() {
      ...
      _export("FetchWalletsError", FetchWalletsError = class FetchWalletsError extends TonConnectError {
        get info() {
      ...
      _export("WrongAddressError", WrongAddressError = class WrongAddressError extends TonConnectError {
        get info() {
      ...
      _export("ParseHexError", ParseHexError = class ParseHexError extends TonConnectError {
        get info() {
      ...
      _export("UnknownError", UnknownError = class UnknownError extends TonConnectError {
        constructor() {
          super(...arguments);
      ...
      BridgeGateway = class BridgeGateway {
        ...
        send(message, receiver, topic, ttlOrOptions) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var body = Base64.encode(message);
            yield callForSuccess(options => __awaiter(this, void 0, void 0, function* () {
              var response = yield this.post(url, body, options.signal);
      ...
      BridgeProvider = class BridgeProvider {
        ...
        restoreConnection(options) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var openingDeadlineMS = (_b = options === null || options === void 0 ? void 0 : options.openingDeadlineMS) !== null && _b !== void 0 ? _b : this.defaultOpeningDeadlineMS;
            ...
            this.listeners.forEach(listener => listener(storedConnection.connectEvent)); // wait for the connection to be opened
        ...
        openGateways(sessionCrypto, options) {
          return __awaiter(this, void 0, void 0, function* () {
            if (Array.isArray(this.walletConnectionSource)) {
              ...
              this.pendingGateways.map(bridge => bridge.close().catch()); // open new gateways

              this.pendingGateways = this.walletConnectionSource.map(source => {
                var gateway = new BridgeGateway(this.storage, source.bridgeUrl, sessionCrypto.sessionId, () => {}, () => {});
      ...
      InjectedProvider = class InjectedProvider {
        ...
        static getCurrentlyInjectedWallets() {
          ...
          var wallets = windowKeys.filter(_ref => {
            var [_, value] = _ref;
            return isJSBridgeWithMetadata(value);
          });
          return wallets.map(_ref2 => {
            var [jsBridgeKey, wallet] = _ref2;
            return {
      ...
      _export("WalletsListManager", WalletsListManager = class WalletsListManager {
        constructor(options) {
      ...
      _export("BrowserEventDispatcher", BrowserEventDispatcher = class BrowserEventDispatcher {
        constructor() {
          /**
      ...
      TonConnectTracker = class TonConnectTracker {
        constructor(options) {
          var _a;
          /**
      ...
      _export("default", _export("TonConnect", TonConnect = class TonConnect {
        constructor(options) {
        ...
        restoreConnection(options) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var restoreConnectionTask = callForSuccess(_options => __awaiter(this, void 0, void 0, function* () {
            ...
            var restoreConnectionTimeout = new Promise(resolve => setTimeout(() => resolve(), 12000) // connection deadline
            );
        ...
        sendTransaction(transaction, optionsOrOnRequestSent) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var result = sendTransactionParser.convertFromRpcResponse(response);
        ...
        disconnect(options) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var abortController = createAbortController(options === null || options === void 0 ? void 0 : options.signal);
            var prevAbortController = this.abortController;
            this.abortController = abortController;
...
//# sourceMappingURL=a0a10e0ad6b6488ca60236ddb88ccad15053dcdb.js.map