  ...
  return {
    ...
    execute: function () {
      ...
      _export("TonToolsViewComponent", TonToolsViewComponent = (_dec = ccclass('TonToolsViewComponent'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = class TonToolsViewComponent extends Component {
        ...
        updateTelegramInfo() {
          var userData = (_crd && TelegramWebApp === void 0 ? (_reportPossibleCrUseOfTelegramWebApp({
            error: Error()
        ...
        onShowJetton() {
          if (this._tonAddressConfig) {
            var jettonMasterAddress = (_crd && Address === void 0 ? (_reportPossibleCrUseOfAddress({
              error: Error()
            }), Address) : Address).parse(this._tonAddressConfig.jettonAddress);

            var show = /*#__PURE__*/function () {
              var _ref = _asyncToGenerator(function* (_gameFi, jettonMasterAddress) {
                //打开 Jetton 合约
                var openJetton = _gameFi.assetsSdk.openJetton(jettonMasterAddress);

                var jettonContent = yield openJetton.getContent();
                var message = "jetton name: " + jettonContent.name + "\njetton decimals: " + jettonContent.decimals;
