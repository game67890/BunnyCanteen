System.register(["@tonconnect/sdk", "ua-parser-js", "deepmerge", "classnames"], function (_export, _context) {
    ...
    if (proxy) {
      return new Proxy({
        ...
        keys() {
          ...
          for (var _i3 = 0; _i3 < sources.length; _i3++) keys.push(...Object.keys(resolveSource(sources[_i3])));
  ...
  function isOS() {
    for (var _len7 = arguments.length, os = new Array(_len7), _key8 = 0; _key8 < _len7; _key8++) {
      os[_key8] = arguments[_key8];
    }
  ...
  function isBrowser() {
    for (var _len8 = arguments.length, browser = new Array(_len8), _key9 = 0; _key9 < _len8; _key9++) {
      browser[_key9] = arguments[_key9];
    }
  ...
  function parseDictionary(dictionary) {
    ...
    var iterate = subDictionary => {
      Object.entries(subDictionary).forEach(_ref2 => {
        var [key, value] = _ref2;
  ...
  function createStore() {
    for (var _len9 = arguments.length, _ref3 = new Array(_len9), _key10 = 0; _key10 < _len9; _key10++) {
      _ref3[_key10] = arguments[_key10];
    }

    var [store, options] = _ref3;
  ...
  function isTmaPlatform() {
    for (var _len11 = arguments.length, platforms = new Array(_len11), _key12 = 0; _key12 < _len11; _key12++) {
      platforms[_key12] = arguments[_key12];
    }
    ...
    if (isInTelegramBrowser()) {
      ...
      if (isOS("ios")) {
        ...
        if (_useDeepLink) {
          ...
          openDeeplinkWithFallback(_deepLink, () => openLinkBlank(_linkWithStrategy2));
        } else {
        ...
        if (_useDeepLink2) {
          ...
          openDeeplinkWithFallback(_deepLink2, () => openLinkBlank(_linkWithStrategy4));
        } else {
        ...
        if (options.forceRedirect) {
          ...
          openDeeplinkWithFallback(_deepLink3, () => openLinkBlank(_linkWithStrategy5));
        }
      } else {
        openLinkBlank(addReturnStrategy(directLinkUrl.toString(), options));
      }
  ...
  function redirectToWallet(universalLink, deepLink, options, setOpenMethod) {
    ...
    if (isInTelegramBrowser()) {
      ...
      if (isTmaPlatform("ios", "android")) {
        ...
        sendOpenTelegramLink(_linkWitStrategy2, () => {
          setOpenMethod("universal-link");
        ...
        if (useDeepLink) {
          ...
          openDeeplinkWithFallback(toDeeplink(_linkWitStrategy3, deepLink), () => {
            setOpenMethod("universal-link");
        ...
        if (_useDeepLink3) {
          setOpenMethod("custom-deeplink");
          openDeeplinkWithFallback(toDeeplink(_linkWitStrategy4, deepLink), () => {
            setOpenMethod("universal-link");
        ...
        if (_useDeepLink4) {
          setOpenMethod("custom-deeplink");
          openDeeplinkWithFallback(toDeeplink(_linkWitStrategy5, deepLink), () => {
            setOpenMethod("universal-link");
      ...
      if (isOS("ios")) {
        ...
        if (_useDeepLink5) {
          setOpenMethod("custom-deeplink");
          openDeeplinkWithFallback(toDeeplink(_linkWitStrategy7, deepLink), () => {
            setOpenMethod("universal-link");
  ...
  function getUniqueBridges(walletsList) {
    var uniqueBridges = new Set(walletsList.filter(isWalletInfoRemote).map(item => item.bridgeUrl));
  ...
  function bridgesIsEqual(left, right) {
    var leftSet = new Set(left == null ? void 0 : left.map(i2 => i2.bridgeUrl));
    var rightSet = new Set(right == null ? void 0 : right.map(i2 => i2.bridgeUrl));
    return leftSet.size === rightSet.size && [...leftSet].every(value => rightSet.has(value));
  }

  return {
    setters: [function (_tonconnectSdk) {
      TonConnectError = _tonconnectSdk.TonConnectError;
      isWalletInfoCurrentlyInjected = _tonconnectSdk.isWalletInfoCurrentlyInjected;
      toUserFriendlyAddress = _tonconnectSdk.toUserFriendlyAddress;
      CHAIN = _tonconnectSdk.CHAIN;
      TonConnect = _tonconnectSdk.TonConnect;
      isTelegramUrl = _tonconnectSdk.isTelegramUrl;
      encodeTelegramUrlParameters = _tonconnectSdk.encodeTelegramUrlParameters;
      isWalletInfoRemote = _tonconnectSdk.isWalletInfoRemote;
      isWalletInfoCurrentlyEmbedded = _tonconnectSdk.isWalletInfoCurrentlyEmbedded;
      createVersionInfo = _tonconnectSdk.createVersionInfo;
      BrowserEventDispatcher = _tonconnectSdk.BrowserEventDispatcher;
      createResponseVersionEvent = _tonconnectSdk.createResponseVersionEvent;
      createRequestVersionEvent = _tonconnectSdk.createRequestVersionEvent;
      createConnectionStartedEvent = _tonconnectSdk.createConnectionStartedEvent;
      createConnectionCompletedEvent = _tonconnectSdk.createConnectionCompletedEvent;
      createConnectionErrorEvent = _tonconnectSdk.createConnectionErrorEvent;
      createConnectionRestoringStartedEvent = _tonconnectSdk.createConnectionRestoringStartedEvent;
      createConnectionRestoringCompletedEvent = _tonconnectSdk.createConnectionRestoringCompletedEvent;
      createConnectionRestoringErrorEvent = _tonconnectSdk.createConnectionRestoringErrorEvent;
      createDisconnectionEvent = _tonconnectSdk.createDisconnectionEvent;
      createTransactionSentForSignatureEvent = _tonconnectSdk.createTransactionSentForSignatureEvent;
      createTransactionSignedEvent = _tonconnectSdk.createTransactionSignedEvent;
      createTransactionSigningFailedEvent = _tonconnectSdk.createTransactionSigningFailedEvent;
      var _exportObj = {};

      for (var _key23 in _tonconnectSdk) {
        if (_key23 !== "default" && _key23 !== "__esModule") _exportObj[_key23] = _tonconnectSdk[_key23];
      }
    ...
    execute: function () {
      ...
      _export("THEME", THEME = /* @__PURE__ */(THEME2 => {
        THEME2["DARK"] = "DARK";
        THEME2["LIGHT"] = "LIGHT";
        return THEME2;
      })(THEME || {}));
      ...
      InMemoryStorage = _InMemoryStorage;

      __publicField(InMemoryStorage, "instance");

      _export("TonConnectUIError", TonConnectUIError = class TonConnectUIError extends TonConnectError {
        constructor() {
          super(...arguments);
      ...
      _tmpl$$u = /* @__PURE__ */template$1("<div></div>");
      ...
      StyledSecondLine = styled(Text)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteralLoose(["\n    font-weight: ", ";\n    max-width: 90px;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    color: ", ";\n\n    ", " {\n        max-width: 80px;\n    }\n"])), props => props.colorPrimary ? "510" : "400", props => props.colorPrimary ? props.theme.colors.text.primary : props.theme.colors.text.secondary, media("mobile"));
      _tmpl$$s = /* @__PURE__ */template$1("<div></div>");

      WalletItem = props => {
        var ctxRef = null;

        var adjustLetterSpacing = () => {
      ...
      LoaderIconStyled$2 = styled(LoaderIcon)(_templateObject47 || (_templateObject47 = _taggedTemplateLiteralLoose(["\n    align-self: center;\n"])));
      ...
      LoaderButtonStyled$1 = styled(Button)(_templateObject53 || (_templateObject53 = _taggedTemplateLiteralLoose(["\n    min-width: 148px;\n    height: 40px;\n\n    background-color: ", ";\n    color: ", ";\n    box-shadow: ", ";\n\n    display: flex;\n    align-items: center;\n    justify-content: center;\n"])), props => props.theme.colors.background.primary, props => props.theme.colors.connectButton.foreground, props => "0 4px 24px " + rgba(props.theme.colors.constant.black, 0.16));
      LoaderIconStyled$1 = styled(LoaderIcon)(_templateObject54 || (_templateObject54 = _taggedTemplateLiteralLoose(["\n    height: 18px;\n    width: 18px;\n"])));
      ...
      AccountButton = () => {
        ...
        var [restoringProcess, setRestoringProcess] = createSignal(!connector.account);
        var dropDownRef;
      ...
      MobileUniversalModal = props => {
        var [showQR, setShowQR] = createSignal(false);
        var [firstClick, setFirstClick] = createSignal(true);
        var [universalLink, setUniversalLink] = createSignal(null);
        ...
        var walletsBridges = createMemo(() => getUniqueBridges(props.walletsList), null, {
          equals: bridgesIsEqual
        });

        var getUniversalLink = () => {
          if (!universalLink()) {
      ...
      LoaderButtonStyled = styled(Button)(_templateObject134 || (_templateObject134 = _taggedTemplateLiteralLoose(["\n    min-width: 112px;\n    margin-top: 32px;\n"])));
      LoaderIconStyled = styled(LoaderIcon)(_templateObject135 || (_templateObject135 = _taggedTemplateLiteralLoose(["\n    height: 16px;\n    width: 16px;\n"])));
      ButtonStyled = styled(Button)(_templateObject136 || (_templateObject136 = _taggedTemplateLiteralLoose(["\n    margin-top: 32px;\n"])));

      ActionModal = props => {
        var dataAttrs = useDataAttributes(props);
        var tonConnectUI = useContext(TonConnectUiContext);
        var [firstClick, setFirstClick] = createSignal(true);
        var [sent, setSent] = createSignal(false);
        createEffect(() => {
      ...
      SingleWalletModalManager = class SingleWalletModalManager {
        ...
        open(wallet) {
          return __async(this, null, function* () {
            ...
            var error = "Trying to open modal window with unknown wallet \"" + wallet + "\".";
      ...
      TonConnectUITracker = class TonConnectUITracker {
        constructor(options) {
        ...
        trackConnectionStarted() {
          try {
            ...
            var event = createConnectionStartedEvent(this.version, ...args);
        ...
        trackConnectionCompleted() {
          try {
            ...
            var event = createConnectionCompletedEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackConnectionError() {
          try {
            ...
            var event = createConnectionErrorEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackConnectionRestoringStarted() {
          try {
            ...
            var event = createConnectionRestoringStartedEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackConnectionRestoringCompleted() {
          try {
            ...
            var event = createConnectionRestoringCompletedEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackConnectionRestoringError() {
          try {
            ...
            var event = createConnectionRestoringErrorEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackDisconnection() {
          try {
            ...
            var event = createDisconnectionEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackTransactionSentForSignature() {
          try {
            ...
            var event = createTransactionSentForSignatureEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackTransactionSigned() {
          try {
            ...
            var event = createTransactionSignedEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
        ...
        trackTransactionSigningFailed() {
          try {
            ...
            var event = createTransactionSigningFailedEvent(this.version, ...args);
            this.dispatchUserActionEvent(event);
          } catch (e2) {}
        }
      ...
      _export("TonConnectUI", TonConnectUI = class TonConnectUI {
        constructor(options) {
...
//# sourceMappingURL=b3e04afbf095bbf7fa326008f322f5e46841bdfe.js.map