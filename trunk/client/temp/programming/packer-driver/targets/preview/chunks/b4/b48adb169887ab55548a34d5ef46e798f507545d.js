  ...
  return {
    ...
    execute: function () {
      ...
      _export("RankComponent", RankComponent = (_dec = ccclass('RankComponent'), _dec2 = property([Node]), _dec3 = property([Sprite]), _dec4 = property(Label), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(_crd && RankVirtualGridList === void 0 ? (_reportPossibleCrUseOfRankVirtualGridList({
        ...
        onAdded(params) {
          var rankTabController = this.node.getComponentInChildren(_crd && RankTabController === void 0 ? (_reportPossibleCrUseOfRankTabController({
            error: Error()
          ...
          this.ShowAllUserNum();
          var RankList = (_crd && RankMgr === void 0 ? (_reportPossibleCrUseOfRankMgr({
            error: Error()
        ...
        ShowUserHead() {
          ...
          var userList = (_crd && RankMgr === void 0 ? (_reportPossibleCrUseOfRankMgr({
            error: Error()
        ...
        ShowRank(rankType, rankConfId, rankList) {
          if (rankType == 1) {
            //兔子币榜
            var Data = (_crd && RankMgr === void 0 ? (_reportPossibleCrUseOfRankMgr({
              error: Error()
            ...
            //餐厅等级榜
            var _Data = (_crd && RankMgr === void 0 ? (_reportPossibleCrUseOfRankMgr({
              error: Error()
            }), RankMgr) : RankMgr).GetRankDataByLevel(rankConfId);
            ...
            if (_Data) {
              (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                error: Error()
              }), UtilMgr) : UtilMgr).SetImage(this.duanweiIcon, _Data.bigrankicon);
              (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
                error: Error()
              }), UtilMgr) : UtilMgr).SetImage(this.duanweiBackImage, _Data.rankpic);
              this.duanweiName.string = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
                error: Error()
              }), oops) : oops).language.getLangByID(_Data.rankname);
              this.duanweiNum.string = (_crd && StringUtil === void 0 ? (_reportPossibleCrUseOfStringUtil({
                error: Error()
              }), StringUtil) : StringUtil).substitute_1((_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
                error: Error()
              }), oops) : oops).language.getLangByID("stringres_198"), _Data.canteenranklower.toString());
        ...
        IsRankListHasMyInfo(rankList, myInfo) {
          for (var id in rankList) {
            var RankData = rankList[id];
