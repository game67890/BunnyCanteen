  ...
  return {
    ...
    execute: function () {
      ...
      _export("Notify", Notify = (_dec = ccclass('Notify'), _dec2 = property(Label), _dec3 = property(Animation), _dec(_class = (_class2 = class Notify extends Component {
        ...
        toast(msg, useI18n) {
          var autoResizeLabel = this.lab_content.getComponent(_crd && AutoResizeLabelPlugin === void 0 ? (_reportPossibleCrUseOfAutoResizeLabelPlugin({
            error: Error()
          ...
          var dynamicBackgroundPlugin = this.lab_content.getComponent(_crd && DynamicBackgroundPlugin === void 0 ? (_reportPossibleCrUseOfDynamicBackgroundPlugin({
            error: Error()
