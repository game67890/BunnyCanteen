  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShopManager", ShopManager = class ShopManager {
        ...
        IsHaveRabbitId(id) {
          for (var i = 0; i < (_crd && TonGameMgr === void 0 ? (_reportPossibleCrUseOfTonGameMgr({
            error: Error()
        ...
        GetRandomAnimation(id) {
          ...
          if (this.tablerecord && this.tablerecord.id && this.tablerecord.id > 0) {
            var index = (_crd && UtilMgr === void 0 ? (_reportPossibleCrUseOfUtilMgr({
              error: Error()
        ...
        SendBuyRabbit(confId) {
          var completeCBuy = ret => {
            ...
            if (ret.isSucc) {
              var tablerecord = new (_crd && TableShop === void 0 ? (_reportPossibleCrUseOfTableShop({
                error: Error()
              }), TableShop) : TableShop)();
