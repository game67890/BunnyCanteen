  ...
  return {
    ...
    execute: function () {
      ...
      _export("TaskComponent", TaskComponent = (_dec = ccclass('TaskComponent'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(_crd && TaskVirtualGridList === void 0 ? (_reportPossibleCrUseOfTaskVirtualGridList({
        ...
        onAdded(params) {
          var taskTabController = this.node.getComponentInChildren(_crd && TaskTabController === void 0 ? (_reportPossibleCrUseOfTaskTabController({
            error: Error()
          ...
          if ((_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
            ...
            (_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
              ...
              var taskList = JSON.parse(res.mission);
              var achievementList = JSON.parse(res.achievement);
              (_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
                error: Error()
        ...
        ShowTaskList() {
          this._taskDataList = [];
          var TaskCellList = (_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
            error: Error()
          }), TaskMgr) : TaskMgr).GetTaskCelllist();
          var TaskGroup = 0;

          for (var id in TaskCellList) {
            var TaskData = TaskCellList[id];
            var ServerData = JSON.parse((_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
              error: Error()
            ...
            if (TaskGroup != TaskData.taskgroup) {
              ...
              var TitleData = JSON.parse(JSON.stringify(TaskData));
        ...
        ShowAchievementList() {
          this._achievementDataList = [];
          var AchievementCellList = (_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
            error: Error()
          }), TaskMgr) : TaskMgr).GetAchievementCellList();

          for (var id in AchievementCellList) {
            var AchievementData = AchievementCellList[id];
            var ServerData = JSON.parse((_crd && TaskMgr === void 0 ? (_reportPossibleCrUseOfTaskMgr({
              error: Error()
