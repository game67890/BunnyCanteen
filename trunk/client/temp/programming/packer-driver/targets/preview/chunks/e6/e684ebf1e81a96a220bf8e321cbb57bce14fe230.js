    ...
    execute: function () {
      ...
      _export("CarrotRewardComponent", CarrotRewardComponent = (_dec = ccclass('CarrotRewardComponent'), _dec2 = property(Button), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Button), _dec6 = property(Label), _dec(_class = (_class2 = class CarrotRewardComponent extends Component {
        ...
        ShowRewardInfo() {
          ...
          var tablerecord = new (_crd && TableOtherParameter === void 0 ? (_reportPossibleCrUseOfTableOtherParameter({
            error: Error()
          ...
          for (var i = 0; i < (_crd && CarrotMgr === void 0 ? (_reportPossibleCrUseOfCarrotMgr({
            error: Error()
        ...
        onCloseBtnClick() {
          ...
          var CarrotMainUI = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
          ...
          if (CarrotMainUI) {
            var CarrotMainCom = CarrotMainUI.getComponent(_crd && CarrotComponent === void 0 ? (_reportPossibleCrUseOfCarrotComponent({
              error: Error()
