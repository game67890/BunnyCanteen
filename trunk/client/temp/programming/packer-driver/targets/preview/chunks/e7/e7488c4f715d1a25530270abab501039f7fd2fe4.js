        ...
        onDataChanged() {
          ...
          var completeLogin = (spriteFrame, uri) => {
            if (spriteFrame && this.headImage) {
              ...
              var rawSize = spriteFrame._originalSize;
              var originalWidth = rawSize.width;
              var originalHeight = rawSize.height; // 计算缩放比例

              var scaleX = this.nodeWidth / originalWidth;
              var scaleY = this.nodeHeight / originalHeight; // 统一缩放比例以保持纵横比
